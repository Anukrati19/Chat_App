...
class MessageCard extends StatefulWidget {
  ...
  const MessageCard({Key? key, required this.message, this.onReactionTap, this.isSelected = false}) : super(key: key);
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            icon,
            Flexible(
              child: Text('    $name', style: const TextStyle(fontSize: 15, color: Colors.black54, letterSpacing: 0.5)),
            )
          ],
        ),
      ),
